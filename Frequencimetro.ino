...
#define D6  12
#define D7  13
// RW conectado ao GND sinalizando escrita
...
// Matriz bidimensional para valor de cada uma das teclas
...
byte linPins[TOTAL_LINHAS] = { L1, L2, L3, L4 };    // Linhas do teclado
byte colPins[TOTAL_COLUNAS] = { C1, C2, C3, C4 };   // Colunas do teclado

Keypad teclado = Keypad( makeKeymap(keys), linPins, colPins, TOTAL_LINHAS, TOTAL_COLUNAS ); // Inicialização do teclado
